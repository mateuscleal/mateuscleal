...
- **TCR Rotas** – App de gerenciamento de rotas.  
- **TCR - Gerenciador de Rotas** – Sistema de suporte a logística.  
- **Inside Out - Site** – Plataforma web desenvolvida em React/Next.js.
